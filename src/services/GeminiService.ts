...
const MyComponent = () => {
  ...
  async generateDocumentation(repoData: any): Promise<any> {
    ...
    const prompt = `
      ...
      Provide your documentation as a JSON object with the following structure:
      {
        ...
        "generatedDate": "string (date generated)",
        "sections": [
          {
      ...
      Focus on helping new developers understand the architecture, workflows, and key components.
      Return ONLY valid JSON conforming to the structure specified above.
    `;
  ...
  /**
   * Method to send requests to Gemini API
   */
